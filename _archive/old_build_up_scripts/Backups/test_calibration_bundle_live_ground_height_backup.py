...
def main():
    ...
    try:
        ...
        print(f"[HEIGHT] lookup robot_z = {robot.object_ground_height_to_lookup_z_mm(target_ground_height):.1f} mm")
        ...
        while True:
            ...
            lines = [
                ...
                f"FK=({x_fk:.1f},{y_fk:.1f},{z_fk:.1f})  target_z={target_z:.1f}",
            ...
            if det_tg is not None:
                lookup_z = robot.object_ground_height_to_lookup_z_mm(target_ground_height)
                ...
                lines.append(
                    ...
                    f"ground_h={target_ground_height:.1f}mm lookup_z={lookup_z:.1f} layers={lo}/{hi} a={alpha:.2f} support={support_dist:.1f}mm {support_status}"
                )
            ...
            if key in (ord("q"), 27):
                ...
                lookup_z = robot.object_ground_height_to_lookup_z_mm(target_ground_height)
                print(f"[HEIGHT] object ground height = {target_ground_height:.1f} mm -> lookup robot_z = {lookup_z:.1f} mm")
                ...
                print(
                    ...
                    f"XY=({x_t:.1f},{y_t:.1f}), travel_z={travel_z:.1f}, target_z={target_z:.1f}"
                )
