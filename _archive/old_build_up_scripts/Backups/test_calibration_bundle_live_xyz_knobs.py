...
def main():
    ...
    try:
        ...
        while True:
            ...
            lines = [
                "z/x height -/+ | [/] jog Z | v validate | m coarse ID2 | r stereo model | p print | h/c sync | q quit",
                f"FK=({x_fk:.1f},{y_fk:.1f},robot_z={z_fk:.1f}) EE_floor={robot_z_to_floor_height_mm(z_fk):.1f}mm",
